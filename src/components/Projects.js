...
const projects = [
    {
        ...
        stack:[
            ...
            {src:"/images/Techs/postgresql.png",title:"PostgreSQL",alt:"postgres icon"},
    ...
    {
        title:"Flagstaff HandyMan Services",
        image:"/images/Projects/handyman_screenshot.png",
...
export const Projects = () => {
    const projectList = projects.map((item, idx) => <Project key={idx} project={item} />);
    return(
