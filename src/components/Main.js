...
import displayImg from '../images/IMG_9450_small.png';
        ...
        <div className="intro_container">
            ...
            <section className="intro_content">
                ...
                <article className="content">
                    <p>My name is Terry Partridge. I am a Software Engineer based in Mission Viejo, California. This is my space, I hope you find it useful.</p>
                </article>
            </section>
        </div>
    );
